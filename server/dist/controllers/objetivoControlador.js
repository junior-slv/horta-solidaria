...
const todosObjetivos = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let objetivos = yield models_1.default.Objetivo.findAll({});
...
const adicionarHorta = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const atualizarHorta = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const deletarHorta = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        const doacao = yield models_1.default.Doacao.findByPk(id);
        if (!doacao) {
...
//# sourceMappingURL=objetivoControlador.js.map